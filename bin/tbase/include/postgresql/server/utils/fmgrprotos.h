...
extern Datum orcl_timestamp_pl_day_i4(PG_FUNCTION_ARGS);
...
extern Datum orcl_timestamp_pl_day_i8(PG_FUNCTION_ARGS);
...
extern Datum orcl_timestamp_pl_day_i2(PG_FUNCTION_ARGS);
...
extern Datum orcl_timestamp_pl_day_n(PG_FUNCTION_ARGS);
...
extern Datum orcl_timestamp_mi_day_i4(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_mi_day_i8(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_mi_day_i2(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_mi_day_n(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_mi(PG_FUNCTION_ARGS);
...
extern Datum orcl_sysdate(PG_FUNCTION_ARGS);
...
extern Datum orcl_systimestamp(PG_FUNCTION_ARGS);
...
extern Datum orcl_get_major_version(PG_FUNCTION_ARGS);
extern Datum orcl_get_major_version_num(PG_FUNCTION_ARGS);
extern Datum orcl_get_full_version_num(PG_FUNCTION_ARGS);
extern Datum orcl_get_platform(PG_FUNCTION_ARGS);
extern Datum orcl_get_status(PG_FUNCTION_ARGS);
extern Datum orcl_set_nls_sort(PG_FUNCTION_ARGS);
extern Datum orcl_nlssort(PG_FUNCTION_ARGS);
extern Datum orcl_totimestamptz(PG_FUNCTION_ARGS);
extern Datum orcl_totimestamp(PG_FUNCTION_ARGS);
extern Datum orcl_todate(PG_FUNCTION_ARGS);
...
extern Datum orcl_add_months(PG_FUNCTION_ARGS);
extern Datum orcl_last_day(PG_FUNCTION_ARGS);
...
extern Datum orcl_months_between(PG_FUNCTION_ARGS);
extern Datum orcl_next_day(PG_FUNCTION_ARGS);
extern Datum orcl_next_day_by_index(PG_FUNCTION_ARGS);
extern Datum orcl_numtoyminterval(PG_FUNCTION_ARGS);
extern Datum orcl_numtodsinterval(PG_FUNCTION_ARGS);
extern Datum orcl_to_yminterval(PG_FUNCTION_ARGS);
...
extern Datum orcl_to_dsinterval(PG_FUNCTION_ARGS);
extern Datum orcl_date_round(PG_FUNCTION_ARGS);
...
extern Datum orcl_timestamp_round(PG_FUNCTION_ARGS);
extern Datum orcl_timestamptz_round(PG_FUNCTION_ARGS);
extern Datum orcl_date_trunc(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_trunc(PG_FUNCTION_ARGS);
extern Datum orcl_timestamptz_trunc(PG_FUNCTION_ARGS);
extern Datum orcl_dbtimezone(PG_FUNCTION_ARGS);
extern Datum orcl_sessiontimezone(PG_FUNCTION_ARGS);
extern Datum orcl_instr4(PG_FUNCTION_ARGS);
extern Datum orcl_instr3(PG_FUNCTION_ARGS);
extern Datum orcl_instr2(PG_FUNCTION_ARGS);
extern Datum orcl_text_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_int4_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_int8_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_float4_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_float8_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_numeric_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_interval_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_timestamp_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_timestamptz_tochar(PG_FUNCTION_ARGS);
extern Datum orcl_text_tonumber(PG_FUNCTION_ARGS);
extern Datum orcl_float4_tonumber(PG_FUNCTION_ARGS);
extern Datum orcl_float8_tonumber(PG_FUNCTION_ARGS);
extern Datum orcl_to_multi_byte(PG_FUNCTION_ARGS);
extern Datum orcl_to_single_byte(PG_FUNCTION_ARGS);
extern Datum orcl_nvl(PG_FUNCTION_ARGS);
extern Datum orcl_nvl2(PG_FUNCTION_ARGS);
extern Datum orcl_lnnvl(PG_FUNCTION_ARGS);
extern Datum orcl_dump(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_5(PG_FUNCTION_ARGS);
...
extern Datum orcl_decode_for_text_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_text_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_bpchar_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int4_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_int8_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_numeric_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_date_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_time_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamp_40(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_3(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_4(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_5(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_6(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_7(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_8(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_9(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_10(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_11(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_12(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_13(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_14(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_15(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_16(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_17(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_18(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_19(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_20(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_21(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_22(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_23(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_24(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_25(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_26(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_27(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_28(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_29(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_30(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_31(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_32(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_33(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_34(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_35(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_36(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_37(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_38(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_39(PG_FUNCTION_ARGS);
extern Datum orcl_decode_for_timestamptz_40(PG_FUNCTION_ARGS);
extern Datum varchar2in(PG_FUNCTION_ARGS);
extern Datum varchar2out(PG_FUNCTION_ARGS);
extern Datum varchar2typmodin(PG_FUNCTION_ARGS);
extern Datum varchar2typmodout(PG_FUNCTION_ARGS);
extern Datum varchar2recv(PG_FUNCTION_ARGS);
extern Datum varchar2send(PG_FUNCTION_ARGS);
...
extern Datum pg_allocated_tablespace_size_oid(PG_FUNCTION_ARGS);
extern Datum pg_allocated_tablespace_size_name(PG_FUNCTION_ARGS);
extern Datum pg_allocated_database_size_oid(PG_FUNCTION_ARGS);
extern Datum pg_allocated_database_size_name(PG_FUNCTION_ARGS);
extern Datum pg_allocated_relation_size(PG_FUNCTION_ARGS);
extern Datum pg_allocated_total_relation_size(PG_FUNCTION_ARGS);
extern Datum pg_allocated_table_size(PG_FUNCTION_ARGS);
extern Datum pg_stat_all_shard(PG_FUNCTION_ARGS);
extern Datum pg_stat_table_shard(PG_FUNCTION_ARGS);
extern Datum clsitemin(PG_FUNCTION_ARGS);
extern Datum clsitemout(PG_FUNCTION_ARGS);
...
extern Datum tbase_set_need_mvcc(PG_FUNCTION_ARGS);
extern Datum tbase_show_need_mvcc(PG_FUNCTION_ARGS);
extern Datum pg_xact_local_commit_timestamp(PG_FUNCTION_ARGS);
...
extern Datum pg_get_audit_action_name(PG_FUNCTION_ARGS);
extern Datum pg_get_audit_action_mode(PG_FUNCTION_ARGS);
extern Datum pg_rotate_audit_logfile(PG_FUNCTION_ARGS);
extern Datum add_policy(PG_FUNCTION_ARGS);
extern Datum drop_policy(PG_FUNCTION_ARGS);
extern Datum enable_policy(PG_FUNCTION_ARGS);
extern Datum disable_policy(PG_FUNCTION_ARGS);
extern Datum enable_all_policy(PG_FUNCTION_ARGS);
extern Datum disable_all_policy(PG_FUNCTION_ARGS);
extern Datum drop_all_policy(PG_FUNCTION_ARGS);
...
extern Datum show_node_lock(PG_FUNCTION_ARGS);
extern Datum pg_node_lock(PG_FUNCTION_ARGS);
extern Datum pg_node_unlock(PG_FUNCTION_ARGS);
